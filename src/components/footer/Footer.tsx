            ...
            <footer className="overflow-x-hidden">
                ...
                lg:flex-row md:flex-nowrap md:justify-between"
                    ...
                    lg:w-[300px] md:w-[220px] ">
                            ...
                            <NavLink to={`user.isAuth ? ${ADMIN_ROUTE}#admin : ${LOGIN_ROUTE}#login`}><li className="text-[14px] text-[#888888] text-start my-[5px]">Личный кабинет</li></NavLink>
                    ...
                    <div className="flex flex-col mt-4 md:flex-row lg:flex-row-reverse justify-between">
                        ...
                        <div className="flex justify-between mb-2">
                            ...
                            <div className="flex justify-center items-center gap-2">
                                <hr />
                                <NavLink to="#"><img className="w-[17px]" src={logo_instagam} alt="Instagram" /></NavLink>
                                <hr />
                                <NavLink to="#"><img className="w-[17px]" src={logo_WhapsApp} alt="WhatsApp" /></NavLink>
                                <hr />
                                <NavLink to="#"><img className="w-[17px]" src={logo_Telegram} alt="Telegram" /></NavLink>
                            </div>
                        </div>
